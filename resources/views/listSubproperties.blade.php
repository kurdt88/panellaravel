...
@section('content_header')
    ...
    <h1>Lista de Subunidades <a href="/newsubproperty" class="btn btn-tool btn-sm">
            [Nueva Subunidad] <button class="btn btn-link"><i class="fas fa-plus"></i></button></a> </h1>
                        ...
                        <td>
                            ...
                            <form style="display:inline;" method="POST" action="/delsubproperty/{{ $subproperty->id }}">
                                ...
                                <button class="btn btn-xs btn-default text-danger mx-1 shadow" title="Delete"
                                    onclick="return confirm('¿Estas seguro de querer borrar la subunidad <<{{ $subproperty->title }}>> ? \n ALERTA Si confirma se borrarán todos los pagos asociados al contrato.')">
