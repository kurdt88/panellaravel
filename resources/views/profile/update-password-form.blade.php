<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <p style="font-size: 16px; color: black;">Password Actual:</p>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <p style="font-size: 16px; color: black;">Nuevo Password:</p>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <p style="font-size: 16px; color: black;">Confirmar Password:</p>
