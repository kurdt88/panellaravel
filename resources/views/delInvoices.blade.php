...
@section('title', 'Borrar Todos los Recibos del Contrato')
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Borrar Recibos (sin pagos ni egresos asociados) </h3>

            </div>


            <form method="POST" action="/delleaseinvoices/{{ $lease->id }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <x-adminlte-card theme="danger" theme-mode="outline">
                    <font>Se eliminirán del sistema los siguientes recibos, los cuales a la fecha <b>no tienen pagos ni
                            egresos
                            asociados<b>:
                    </font>
                    <br> <br>
                ...
                <div class="card-footer">
                    ...
                    <x-adminlte-button class="btn-sm" type="submit" label="Eliminar Recibos" theme="outline-danger"
